...
from api.views import DownloadResume, GetGitHubRepos, GetLeetCodeData, GetMediumData, GetGitHubUserData
...
urlpatterns = [
    ...
    path('gituser/', GetGitHubUserData, name='get_gituser_data'),
